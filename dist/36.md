...
```dll（変更前:GetSystemTimeAsFileTime関数）
...
```dll（変更後:GetSystemTimeAsFileTime関数）
00000BE0                 8B FF 55 8B EC A1 18 00 FE 7F 8B 
00000BF0  15 14 00 FE 7F 3B 05 1C 00 FE 7F 75 ED 8B 4D 08 
...
```
msr[174] = 0000000000000008
kd> rdmsr 175
msr[175] = 00000000f9e73000
kd> rdmsr 176
msr[176] = 00000000804e0f6f
```
