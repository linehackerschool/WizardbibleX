...
```
defolos@glazheim:~/Desktop$ ./a.out AAAAperl -e 'print "%08x."x8;'
Good:
...
●Comment:
　最近はいろんなアプリの負荷テストでクアッドコア+8GBのテストマシン3台をフル稼働させてます
ヽ(´ー)ノ電気代どうなってるのｗｗｗ　64bitLinuxモエー
●好きな映画・お勧めの映画: 
